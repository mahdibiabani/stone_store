...
SECRET_KEY = "django-insecure-tsew6@y&6%%_04doy^z$1))#%ja!o8@*#9xlvvhof-x!5ogg9t"
...
# Mock payment for development (set to True to use mock instead of real ZarinPal)
USE_MOCK_PAYMENT = True

# Jazzmin settings
JAZZMIN_SETTINGS = {
    # title of the window (Will default to current_admin_site.site_title if absent or None)
    "site_title": "Stone Store Admin",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "Stone Store",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "Stone Store Admin",
    ...
    "welcome_sign": "Welcome to Stone Store Admin Panel",

    # Copyright on the footer
    "copyright": "Stone Store Ltd",

    # List of model admins to search from the search bar, search bar omitted if excluded
    "search_model": ["auth.User", "store.Stone", "store.Project", "store.Quote"],
    ...
    "custom_links": {
        "store": [{
            ...
            "url": "admin:store_stone_changelist", 
            "icon": "fas fa-chart-bar",
            "permissions": ["store.view_stone"]
        }]
    },
    ...
    "icons": {
        ...
        "store.Stone": "fas fa-gem",
        "store.Category": "fas fa-tags",
        "store.Project": "fas fa-building",
        "store.Cart": "fas fa-shopping-cart",
        "store.CartItem": "fas fa-cart-plus",
        "store.Quote": "fas fa-file-invoice",
        "store.QuoteItem": "fas fa-list",
    ...
    "custom_css": "admin/css/rtl-support.css",
    "custom_js": "admin/js/rtl-handler.js",
